...
let tierA = ["evasasha","july_koss","_milkyway","mango_shake","lilly_vanilla","cogitademe","hayley__lee","candysfox","yournaughtymiss","annie_sweetyxx","lovely_aria","anna_sabotage","lolla_molla","hell_lo","_woweva__","lola_bunny94","thepleasureofsex","sweet__sugar","wild_schoolgirl","catanddickxxx"];
let fn__tierA = async () => { tierA.forEach(m => addModel(m, 23)); }
fn__tierA();

let tierB = ["jessica_jonses","little_vee","qeensgambit","tiffanyhouston_","marylanex","sweet_tinker_bell","selfish_ashley","alice_kosmos","juicekatee","blackmango_mary","kinkyali","feelmemore","_virtual_lady_","sallysarry","hayle_green","liisppb","evelissa","melisasweety","funnysimka","amazon_girl","vivian_clark","lillpio","xllodaz","amazing_roxana","miley_k18","merrilyn","grande_niks_","amelie_25","kimber_r","maryjunie","agatha137","heyhorny_cb","tonibrock","cutemoments","soo_emma","love_4_y","cunty_paradise"];
