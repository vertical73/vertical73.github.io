...
let tierA = ["evasasha","july_koss","_milkyway","mango_shake","lilly_vanilla","candysfox","yournaughtymiss","annie_sweetyxx","cogitademe","hayley__lee","lovely_aria","anna_sabotage","lolla_molla","hell_lo","_woweva__","alice_kosmos","lola_bunny94","thepleasureofsex","sweet__sugar","wild_schoolgirl","catanddickxxx"];
let fn__tierA = async () => { tierA.forEach(m => addModel(m, 23)); }
fn__tierA();

let tierB = ["jessica_jonses","sallysarry","little_vee","tiffanyhouston_","marylanex","juicekatee","sweet_tinker_bell","vivian_clark","blackmango_mary","kinkyali","feelmemore","hayle_green","_virtual_lady_","liisppb","evelissa","melisasweety","selfish_ashley","funnysimka","lillpio","qeensgambit","agatha137","kleasure","amazing_roxana","tonibrock","heyhorny_cb","miley_k18","kimber_r","merrilyn","katrinpolly","babymetalweb"];
