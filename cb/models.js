...
let tierA = ["evasasha","july_koss","_milkyway","mango_shake","lilly_vanilla","candysfox","yournaughtymiss","annie_sweetyxx","cogitademe","hayley__lee","lovely_aria","anna_sabotage","lolla_molla","hell_lo","_woweva__","lola_bunny94","thepleasureofsex","sweet__sugar","wild_schoolgirl","catanddickxxx"];
let fn__tierA = async () => { tierA.forEach(m => addModel(m, 23)); }
fn__tierA();

let tierB = ["jessica_jonses","sallysarry","little_vee","tiffanyhouston_","marylanex","juicekatee","sweet_tinker_bell","alice_kosmos","vivian_clark","blackmango_mary","kinkyali","feelmemore","hayle_green","_virtual_lady_","jenniferlove_hewitt","liisppb","evelissa","melisasweety","selfish_ashley","funnysimka","katrinpolly","lillpio","qeensgambit","amazing_roxana","miley_k18","merrilyn","kimber_r","babymetalweb","agatha137","heyhorny_cb","tonibrock"];
